(function ($) {
    ...
    $.fn.jqueryBootstrapWizard.wizardTemplate = '<div id="jqb-wizard" class="card border" style="width: 60rem;">' +
        '    {HEADER}' +
        '    {BODY}' +
        '    {FOOTER}' +
        '</div>';
    ...
    $.fn.jqueryBootstrapWizard.footerTemplate = '<div id="jqb-footer" class="card-footer">' +
        ...
        '<a id="jqb-btn-next" class="btn btn-primary text-white" >{NEXT_LABEL}</a>' +
        '</div></div>';
